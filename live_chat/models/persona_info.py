...
class InterviewState(Enum):
    INITIAL_INTERVIEW = 0
    JOB_DOMAIN_INTERVIEW = 1
    JOB_FEEDBACK_INTERVIEW = 2
    TRAINING_DOMAIN_INTERVIEW = 3
    TRAINING_FEEDBACK_INTERVIEW = 4
    OPEN_DISCUSSION = 10
    STOP = 100
...
class UserInterview(BaseModel):
    interview_state: InterviewState = InterviewState.INITIAL_INTERVIEW
    persona_info: PersonaInfo = PersonaInfo()
